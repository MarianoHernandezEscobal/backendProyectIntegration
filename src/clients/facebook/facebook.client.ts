...
export class FacebookClient {
  ...
  createPost(body: CreatePost): Observable<any> {
    ...
    const accessToken = this.configService.get<string>('FACEBOOK_ACCESSTOKEN');
  ...
  renewAccessTokenUser(): Observable<any> {
    ...
    const userAccessToken = this.configService.get<string>('FACEBOOK_USER_ACCESSTOKEN');

    return this.httpService
      .get(`${facebookUrl}oauth/access_token`, {
        params: {
